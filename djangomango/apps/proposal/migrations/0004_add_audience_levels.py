...
from ..models import AudienceLevel

AUDIENCE_LEVELS = ['Novice', 'Intermediate', 'Experienced']


class Migration(DataMigration):

    def forwards(self, orm):
        levels = [AudienceLevel(name=n) for n in AUDIENCE_LEVELS]
        AudienceLevel.objects.bulk_create(levels)
